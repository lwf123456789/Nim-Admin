  ...
  return (
    <DefaultLayout>
      <div className="mx-auto max-w-242.5">
        <Breadcrumb pageName="个人信息" />

        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="relative z-20 h-35 md:h-65">
            <Image
              src={"https://cdn.pixabay.com/photo/2024/03/04/14/17/ai-generated-8612487_640.jpg"}
              alt="profile cover"
              className="rounded-tl-sm rounded-tr-sm h-[340px]"
              width={1150}
              height={100}
            />
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
              <div className="relative drop-shadow-2">
                <Image
                  src={"https://cdn.iconscout.com/icon/premium/png-256-thumb/programmer-2105401-1770286.png?f=webp&w=128"}
                  width={160}
                  height={160}
                  style={{
                    width: "auto",
            ...
            <div className="mt-4">
              ...
              <p className="font-medium">高级软件工程师</p>
              <div className="mx-auto mb-5.5 mt-4.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
                <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                  <span className="font-semibold text-black dark:text-white">
                    160
                  </span>
                  <span className="text-sm">研发产品</span>
                </div>
                <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                  <span className="font-semibold text-black dark:text-white">
                    12K
