  ...
  <div className="mb-10 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
    <div className="p-4 md:p-6 xl:p-9">
            ...
            <div className="mb-7.5 flex flex-wrap gap-5 xl:gap-20">
              <ButtonOne text="Button" backgroundColor="bg-primary" onClick={handleClick} loading={loading} />
              <ButtonOne text="Button" backgroundColor="bg-primary" border borderColor="border-primary" />
              <ButtonOne text="Button" backgroundColor="bg-primary" icon={<ButtonIcon />} />
              <ButtonOne text="Button" border borderColor="border-black" textColor="text-white" borderRadius="rounded-full" />
            </div>

            {/* Meta-3 Buttons */}
            <div className="mb-7.5 flex flex-wrap gap-5 xl:gap-20">
              <ButtonOne text="Button" backgroundColor="bg-meta-3" />
              <ButtonOne text="Button" backgroundColor="bg-meta-3" border borderColor="border-meta-3" />
              <ButtonOne text="Button" backgroundColor="bg-meta-3" icon={<ButtonIcon />}/>
              <ButtonOne text="Button" border borderColor="border-meta-3" textColor="text-meta-3" borderRadius="rounded-full" />
            </div>

            {/* Black Buttons */}
            <div className="mb-7.5 flex flex-wrap gap-5 xl:gap-20">
              <ButtonOne text="Button" backgroundColor="bg-black" />
              <ButtonOne text="Button" backgroundColor="bg-black" border borderColor="border-black" />
              <ButtonOne text="Button" backgroundColor="bg-black" icon={<ButtonIcon />} />
              <ButtonOne text="Button" border borderColor="border-black" textColor="text-black" borderRadius="rounded-full" />
            </div>

            {/* Danger Buttons */}
            <div className="flex flex-wrap gap-5 xl:gap-20">
              <ButtonOne text="Button" backgroundColor="bg-danger" />
              <ButtonOne text="Button" backgroundColor="bg-danger" border borderColor="border-danger" />
              <ButtonOne text="Button" backgroundColor="bg-danger" icon={<ButtonIcon />} />
              <ButtonOne text="Button" backgroundColor="bg-danger" border borderColor="border-white" textColor="text-white" borderRadius="rounded-full" />
            </div>
    </div>
  </div>
)};
