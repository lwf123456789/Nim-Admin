...
const ErrorPage: React.FC = () => {
  return (
    <DefaultLayout>
      <Breadcrumb pageName="错误页面" />
      <div className="flex justify-center flex-col items-center rounded-sm border border-stroke bg-white mt-10 px-5 py-10 shadow-default dark:border-strokedark dark:bg-boxdark sm:py-20">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-600 mt-2">服务器错误</p>
            <p className="md:text-lg xl:text-xl text-gray-500 mt-4">糟糕，我们的服务器出了点问题。</p>
            <Link
              href="/"
      ...
      <div className="rounded-sm border border-stroke bg-white mt-10 px-5 py-10 shadow-default dark:border-strokedark dark:bg-boxdark sm:py-20">
        <div className="mx-auto max-w-[410px]">
          <Image
            src={"https://cdni.iconscout.com/illustration/premium/thumb/boy-feeling-sad-due-to-page-not-found-error-4606299-3809632.png?f=webp"}
            alt="illustration"
            width={400}
            height={400}
          />
