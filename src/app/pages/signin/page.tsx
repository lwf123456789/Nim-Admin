        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              ...
              <Image width={176} height={32} src="https://cdni.iconscout.com/illustration/premium/thumb/account-login-6003624-4976687.png?f=webp" alt="" />
              <span className="font-bold text-graydark text-2xl dark:text-white">登录</span>
              </Link>
              ...
              <span className="mt-15 inline-block">
                <Image width={350} height={350} src="https://cdni.iconscout.com/illustration/premium/thumb/login-page-2578971-2147152.png?f=webp" alt="" />
              </span>
            </div>
          </div>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">欢迎！</span>
