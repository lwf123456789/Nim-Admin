...
const todoData = [
  {
    logo: "https://cdn.vectorstock.com/i/500p/16/84/meeting-deadlines-icon-vector-10471684.jpg",
    title: "2024年度客户会议",
    time: "上午 10:20 - 下午 3:00",
    date: "2024年2月14日",
    status: 1,
  },
  {
    logo: "https://cdn.vectorstock.com/i/500p/80/98/business-people-are-having-a-meeting-vector-51638098.jpg",
    title: "2024销售培训会",
    time: "上午 9:30 - 上午 12:00",
    date: "2024年2月14日",
    status: 2,
  },
  {
    logo: "https://cdn.vectorstock.com/i/500p/64/17/woman-raise-hand-volunteer-at-team-meeting-vector-51006417.jpg",
    title: "2024团队建设活动",
    time: "上午 10:30 - 下午 11:00",
    date: "2024年2月14日",
    status: 3,
  },
];
...
const statusStyles:Record<number,string> = {
  1: "bg-meta-3/[0.08] text-meta-3", // 已完成
  2: "bg-primary/[0.08] text-primary", // 即将进行
  3: "bg-red/[0.08] text-red", // 已取消
};
          ...
          <div className="flex flex-col gap-6">
            ...
            {todoData.map((todo, key) => (
              <div className="flex items-center justify-between" key={key}>
                ...
                <span
                    className={`inline-block rounded px-2.5 py-1.5 text-sm font-medium ${statusStyles[todo.status]}`}
                  >
                    {todo.status === 1 ? "已完成" : todo.status === 2 ? "即将进行" : "已取消"}
                  </span>
              </div>
            ))}
          </div>
