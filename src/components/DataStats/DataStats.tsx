      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4 xl:gap-0">
        <div className="flex items-center justify-center gap-2 border-b border-stroke pb-5 dark:border-strokedark xl:border-b-0 xl:border-r xl:pb-0">
          <div>
            ...
            <p className="text-sm font-medium">总销售额</p>
          </div>
        ...
        <div className="flex items-center justify-center gap-2 border-b border-stroke pb-5 dark:border-strokedark xl:border-b-0 xl:border-r xl:pb-0">
          <div>
            ...
            <p className="text-sm font-medium">订单数量</p>
          </div>
          <div className="flex items-center gap-1">
            <svg
              width="19"
        ...
        <div className="flex items-center justify-center gap-2 border-b border-stroke pb-5 dark:border-strokedark sm:border-b-0 sm:pb-0 xl:border-r">
          <div>
            ...
            <p className="text-sm font-medium">新客户数量</p>
          </div>
          <div className="flex items-center gap-1">
            <svg
              width="19"
            ...
            <span className="text-meta-3">8.6%</span>
          </div>
        </div>
        <div className="flex items-center justify-center gap-2">
          <div>
            ...
            <p className="text-sm font-medium">退货率</p>
          </div>
          <div className="flex items-center gap-1">
            <svg
              width="19"
            ...
            <span className="text-meta-8">2.1%</span>
          </div>
        </div>
      </div>
    </div>
