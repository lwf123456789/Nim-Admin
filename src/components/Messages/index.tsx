...
const Messages: React.FC = () => {
  const chatList = [
    {
      imgSrc: "https://cdn-icons-png.flaticon.com/128/6214/6214046.png",
      name: "丽莎·王",
      messages: [
    ...
    {
      imgSrc: "https://cdn.iconscout.com/icon/premium/png-256-thumb/programmer-2105401-1770286.png?f=webp&w=128",
      name: "亨利·多利",
      messages: [
        { sender: "安德里·托马斯", message: "我想预约明天下午2:00到5:00的时间，可以吗？", time: "1:55pm", self: false },
        { sender: "自己", message: "你好，托马斯！我会查看日程并通知你。", time: "1:55pm", self: true },
        { sender: "安德里·托马斯", message: "好的，谢谢你的回复。", time: "1:55pm", self: false },
        { sender: "自己", message: "不客气！", time: "1:55pm", self: true },
      ],
    },
    {
      imgSrc: "https://cdn-icons-png.flaticon.com/128/10061/10061694.png",
      name: "玛丽亚·德索亚",
      messages: [
        { sender: "玛丽亚·德索亚", message: "我很喜欢你的自信 💪", time: "2:00pm", self: false },
        { sender: "自己", message: "谢谢你！", time: "2:01pm", self: true },
      ],
    },
    {
      imgSrc: "https://cdn-icons-png.flaticon.com/128/1995/1995515.png",
      name: "艾米·布朗",
      messages: [
        { sender: "艾米·布朗", message: "你用过React hooks吗？", time: "3:15pm", self: false },
        { sender: "自己", message: "用过，我觉得它们非常方便。", time: "3:17pm", self: true },
        { sender: "艾米·布朗", message: "能给我举个例子吗？", time: "3:18pm", self: false },
      ],
    },
    {
      imgSrc: "https://cdn-icons-png.flaticon.com/128/10061/10061876.png",
      name: "约翰·史密斯",
      messages: [
        { sender: "约翰·史密斯", message: "你怎么看TypeScript？", time: "4:20pm", self: false },
        { sender: "自己", message: "我认为TypeScript能提高代码的可读性和可维护性。", time: "4:22pm", self: true },
        { sender: "约翰·史密斯", message: "完全同意，我最近也在学习。", time: "4:23pm", self: false },
      ],
    },
  ];
        ...
        <div className="h-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark xl:flex">
          <div className="hidden h-full flex-col xl:flex xl:w-1/4">
            ...
            <div className="flex h-full flex-col overflow-auto p-5">
              ...
              <div className="no-scrollbar h-full space-y-2.5 overflow-auto">
                {chatList.map((chat, index) => (
                  ...
                  >
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-sm">{chat.messages[0].message}</p>
                    </div>
                  </div>
                ))}
              </div>
