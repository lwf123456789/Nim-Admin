...
const leadsData: Lead[] = [
  {
    ...
    name: "李华",
    email: "lihua@qq.com",
    project: "2024年12月25日 - 2024年12月28日",
    duration: 3,
    status: "lost",
  },
  {
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="border-b border-stroke px-4 pb-5 dark:border-strokedark md:px-6 xl:px-7.5">
          <div className="flex items-center gap-3">
            ...
            <div className="w-6/12 2xsm:w-5/12 md:w-3/12 text-center">
              <span className="font-medium">邮箱</span>
            </div>
            <div className="hidden w-4/12 md:block xl:w-3/12 text-center">
              <span className="font-medium">项目</span>
            </div>
            <div className="hidden w-1/12 xl:block text-center">
          ...
          <div className="flex flex-col gap-7">
            {leadsData.map((lead, key) => (
              <div className="flex items-center gap-3" key={key}>
                ...
                <div className="hidden w-1/12 xl:block text-center">
                  <span className="font-medium">{lead.duration} 天</span>
                </div>
                <div className="w-4/12 2xsm:w-3/12 md:w-2/12 xl:w-1/12 text-center">
                  <span
                  ...
                  >
                     {lead.status === "lost" ? "潜在客户" : "活跃"}
                  </span>
                </div>
                <div className="hidden w-2/12 2xsm:block md:w-1/12 text-center">
