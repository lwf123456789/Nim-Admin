...
const faqItems: Faq[] = [
  {
    title: "Nim Admin 是否有详细的文档？",
    details: "是的，Nim Admin 提供了详尽的文档，帮助开发者快速上手和深入了解各个组件的使用方法。",
  },
  {
    title: "Nim Admin 是否支持定制化？",
    details: "Nim Admin 允许开发者根据需求自定义组件的样式和功能，提供了高度的灵活性。",
  },
  {
    title: "Nim Admin 兼容性如何？",
    details: "Nim Admin 兼容主流浏览器，并支持响应式设计，确保在各种设备上都有良好的表现。",
  },
  {
    title: "如何获取 Nim Admin 的支持？",
    details: "您可以通过我们的官网获取技术支持和帮助文档，也可以加入我们的社区与其他开发者交流。",
  },
];
